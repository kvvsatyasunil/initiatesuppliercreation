		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comtsmdginitiatesuppliercreation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtsmdginitiatesuppliercreation-display": {
								"semanticObject": "comtsmdginitiatesuppliercreation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ts.mdg.initiatesuppliercreation",
									"url": sap.ui.require.toUrl("com/ts/mdg/initiatesuppliercreation")
								}
							}
						}
					}
